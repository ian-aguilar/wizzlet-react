...
const AdminMarketplace = () => {
  ...
  const { getMarketplaceAdminListingAPI, isLoading: marketplaceLoading } =
    useMarketplaceAdminListingAPI();
  const { setMarketplaceStatusAPI, isLoading } = useMarketplaceStatusAPI();
  const marketplaceListing = async () => {
    const { data, error } = await getMarketplaceAdminListingAPI();
    if (!error && data) {
